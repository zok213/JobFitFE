        ...
        <div className="w-full max-w-6xl mx-auto px-4 py-12 md:py-20">
                ...
                <div className="relative bg-zinc-900 rounded-full p-1 w-72 h-12 flex items-center">
                  <button 
                    className={`relative z-10 flex-1 flex justify-center items-center h-full rounded-full px-3 font-medium text-sm transition-colors duration-200 ${
                      billingCycle === "monthly" ? "text-black" : "text-lime-300"
                    }`}
                  ...
                  {billingCycle === "annual" && (
                    <div className="absolute -top-2 -right-2 bg-lime-300 rounded-full px-2 py-0.5 text-[10px] font-bold text-black border border-black/10 shadow-sm">
                      Save {activeTab === "employee" ? employeeAnnualDiscount : employerAnnualDiscount}%
                    </div>
                  )}
                </div>
              </div>
                  ...
                  {employeeTiers.map((tier, i) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <CardHeader className={`${tier.popular ? "pt-6" : "pt-8"} pb-4`}>
                          <div className="flex items-center justify-center mb-2">
                            <div className={`p-3 rounded-full ${tier.popular ? "bg-lime-100" : "bg-gray-100"} transition-all duration-300 group-hover:scale-110`}>
                              {tier.icon}
                            </div>
                          </div>
                        ...
                        <CardContent className="pb-8 flex-grow">
                          <h3 className="font-semibold mb-3 text-zinc-900 flex items-center">
                            <Check className="h-4 w-4 text-lime-500 mr-2" /> Includes:
                          </h3>
                    ...
                    <div className="overflow-x-auto">
                      <table className="w-full text-sm">
                        <thead>
                          <tr className="border-b">
                            <th className="text-left py-4 px-6 font-medium text-zinc-900">Feature</th>
                            <th className="text-center py-4 px-4 font-medium text-zinc-900">Starter</th>
                            <th className="text-center py-4 px-4 font-medium text-zinc-900 bg-lime-50">Business</th>
                            <th className="text-center py-4 px-4 font-medium text-zinc-900">Enterprise</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr className="border-b">
                            <td className="py-4 px-6 text-gray-700">Active Job Postings</td>
                            <td className="text-center py-4 px-4 text-gray-700">5</td>
                            <td className="text-center py-4 px-4 bg-lime-50 font-medium text-gray-800">25</td>
                            <td className="text-center py-4 px-4 text-gray-700">Unlimited</td>
                          </tr>
                          <tr className="border-b">
                            <td className="py-4 px-6 text-gray-700">AI Candidate Matching</td>
                            <td className="text-center py-4 px-4 text-gray-700">Basic</td>
                            <td className="text-center py-4 px-4 bg-lime-50 font-medium text-gray-800">Advanced</td>
                            <td className="text-center py-4 px-4 text-gray-700">Premium</td>
                          </tr>
                          <tr className="border-b">
                            <td className="py-4 px-6 text-gray-700">CV Analysis</td>
                            <td className="text-center py-4 px-4 text-gray-700">10/month</td>
                            <td className="text-center py-4 px-4 bg-lime-50 font-medium text-gray-800">Unlimited</td>
                            <td className="text-center py-4 px-4 text-gray-700">Unlimited</td>
                          </tr>
                          <tr className="border-b">
                            <td className="py-4 px-6 text-gray-700">Job Visibility</td>
                            <td className="text-center py-4 px-4 text-gray-700">Standard</td>
                            <td className="text-center py-4 px-4 bg-lime-50 font-medium text-gray-800">Enhanced</td>
                            <td className="text-center py-4 px-4 text-gray-700">Maximum</td>
                          </tr>
                          <tr className="border-b">
                            <td className="py-4 px-6 text-gray-700">Support</td>
                            <td className="text-center py-4 px-4 text-gray-700">Email</td>
                            <td className="text-center py-4 px-4 bg-lime-50 font-medium text-gray-800">Priority</td>
                            <td className="text-center py-4 px-4 text-gray-700">Dedicated Manager</td>
                          </tr>
                          <tr className="border-b">
                            <td className="py-4 px-6 text-gray-700">ATS Integration</td>
                            <td className="text-center py-4 px-4">
                              <X className="h-5 w-5 text-gray-400 mx-auto" />
                            </td>
                            <td className="text-center py-4 px-4 bg-lime-50">
                          ...
                          <tr>
                            <td className="py-4 px-6 text-gray-700">Talent Pool Management</td>
                            <td className="text-center py-4 px-4">
                              <X className="h-5 w-5 text-gray-400 mx-auto" />
                            </td>
                            <td className="text-center py-4 px-4 bg-lime-50">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Link href="/faq">
                <Button variant="outline" className="border-gray-300 hover:border-gray-400 hover:bg-gray-50 h-12 px-6">
                  Browse FAQ
                </Button>
              </Link>
              <Link href="/contact">
          ...
          >
            <div className="flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-bold mb-2 text-zinc-900 text-center md:text-left">Try JobFit.AI risk-free</h3>
