...
export default function DashboardPage() {
  ...
  return (
    <DashboardShell activeNavItem="dashboard">
      <div className="w-full max-w-7xl mx-auto px-4 py-6">
            ...
            {shortcuts.map((shortcut) => (
              ...
              >
                <CardContent className="p-6 flex flex-col h-full">
                  ...
                  <CardTitle className="text-lg font-bold">{shortcut.title}</CardTitle>
                  <CardDescription className="mt-1 mb-4">{shortcut.description}</CardDescription>
        ...
        {/* Notification */}
        {notification && (
          <div className={`fixed bottom-4 right-4 p-4 rounded-lg shadow-lg flex items-center gap-3 max-w-md animate-slide-up 
