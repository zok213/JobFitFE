...
export function CVBuilder() {
  ...
  const [completedSections, setCompletedSections] = useState<string[]>(["personal"]);
  ...
  const handleNextSection = () => {
    const tabOrder = ["personal", "summary", "experience", "education", "skills", "links", "custom"];
      ...
      <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className={`px-2 py-1 rounded-full text-xs font-medium ${
                getResumeScore() < 40 ? 'bg-red-100 text-red-800' : 
                getResumeScore() < 70 ? 'bg-yellow-100 text-yellow-800' : 
            ...
            <p className="text-xs text-gray-500 mt-1">
              {getResumeScore() < 40 ? 'Your CV needs more information' : 
              getResumeScore() < 70 ? 'Your CV is getting there' : 
        ...
        <div className="flex-1">
          <Tabs value={activeTab} className="w-full">
            <TabsContent value="personal" className="m-0 bg-white rounded-xl p-1">
            ...
            <TabsContent value="summary" className="m-0 bg-white rounded-xl p-1">
            ...
            <TabsContent value="experience" className="m-0 bg-white rounded-xl p-1">
            ...
            <TabsContent value="education" className="m-0 bg-white rounded-xl p-1">
              <EducationSection 
            ...
            <TabsContent value="custom" className="m-0 bg-white rounded-xl p-1">
              <CustomSectionsPanel 
                ...
                updateData={(data) => updateCVData("customSections", data)}
              />
            </TabsContent>
          </Tabs>
