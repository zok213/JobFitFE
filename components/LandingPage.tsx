    ...
    <main className="bg-white min-h-screen flex flex-col">
      ...
      >
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-center md:justify-between gap-6 text-sm">
          <div className="flex items-center gap-2">
            ...
            <p className="text-slate-700 font-medium">Rated 4.8/5 from over 1,200+ reviews</p>
          </div>
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-3">
            <Badge variant="outline" className="bg-white">Data Privacy Compliant</Badge>
            <Badge variant="outline" className="bg-white">GDPR Certified</Badge>
            <Badge variant="outline" className="bg-white">ISO 27001 Certified</Badge>
            <Badge variant="outline" className="bg-white">SOC 2 Compliant</Badge>
          </div>
        </div>
      </motion.section>
      ...
      >
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12 relative z-10">
          <div className="text-white max-w-2xl">
            ...
            >
              Join thousands of professionals who've found their dream job with JobFit.AI's intelligent matching technology.
            </motion.p>
            <motion.div 
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <Link href="/register">
                <Button size="lg" className="bg-gradient-to-r from-lime-300 to-lime-400 text-black hover:from-lime-200 hover:to-lime-300 font-medium shadow-xl hover:shadow-lime-400/20 transition-all hover:-translate-y-0.5 duration-300">
                  Get Started Free
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-lime-300 to-lime-400">93%</p>
              ...
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-lime-300 to-lime-400">10,000+</p>
              ...
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-lime-300 to-lime-400">4.8/5</p>
      ...
      >
        <div className="max-w-5xl mx-auto text-center">
          <Badge variant="lime" className="mb-4">SUCCESS STORIES</Badge>
          <h2 className="text-3xl md:text-4xl font-bold mb-12">What our users are saying</h2>
