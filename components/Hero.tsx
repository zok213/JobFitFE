      ...
      <div className="relative z-10 flex flex-col px-6 md:px-12 lg:px-24 py-20 md:py-28 max-w-[1440px] mx-auto">
        <div className="flex justify-between items-center max-lg:flex-col max-lg:items-start">
          ...
          >
            ...
            >
              {[
                { text: "Personalized job matching", icon: <Check className="text-lime-500 mr-2 h-5 w-5 mt-0.5 flex-shrink-0" /> },
                { text: "AI CV optimization", icon: <Check className="text-lime-500 mr-2 h-5 w-5 mt-0.5 flex-shrink-0" /> },
                { text: "Interview preparation", icon: <Check className="text-lime-500 mr-2 h-5 w-5 mt-0.5 flex-shrink-0" /> },
                { text: "Career roadmap planning", icon: <Check className="text-lime-500 mr-2 h-5 w-5 mt-0.5 flex-shrink-0" /> }
              ].map((item, index) => (
                <motion.div 
                  key={index}
          ...
          {user ? (
            ...
            >
              <div className="flex -space-x-3">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className={`w-8 h-8 rounded-full border-2 border-white bg-gray-${i*100} shadow-sm`}></div>
                ))}
        </div>
              <p className="font-medium">Joined by <span className="text-black font-bold">10,000+</span> job seekers and <span className="text-black font-bold">500+</span> employers</p>
            </motion.div>
          </motion.div>
            ...
            >
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-xs text-gray-500">95% match with your profile</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Personalized career insights</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
