    ...
    <div className="flex min-h-screen w-full items-center justify-center bg-gradient-to-br from-lime-300 to-lime-400 p-4">
      ...
      >
          ...
          <CardContent className="px-8 pb-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="text-center mt-6">
                ...
                <Link href="/register" className="text-lime-600 font-semibold hover:text-lime-700 transition-colors">
                  Create Account
                </Link>
              </div>
        ...
        <div className="text-center mt-4 text-sm text-white/80">
          By signing in, you agree to our <Link href="/terms" className="underline hover:text-white">Terms of Service</Link> and <Link href="/privacy" className="underline hover:text-white">Privacy Policy</Link>
        </div>
      </motion.div>
    </div>
  );
