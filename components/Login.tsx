  ...
  const socialLogins = [
    {
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M18 2H15C13.6739 2 12.4021 2.52678 11.4645 3.46447C10.5268 4.40215 10 5.67392 10 7V10H7V14H10V22H14V14H17L18 10H14V7C14 6.73478 14.1054 6.48043 14.2929 6.29289C14.4804 6.10536 14.7348 6 15 6H18V2Z" stroke="#0866FF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      ),
      alt: "Facebook login",
    },
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end">
              <Link 
                ...
                className="text-sm text-zinc-600 hover:text-lime-700 hover:underline"
              >
                Forgot password?
              </Link>
            </div>
            ...
            <div className="text-center">
              ...
              <Link href="/register" className="text-lime-700 font-semibold hover:underline">
                Register
              </Link>
            </div>
            
            <div className="relative flex items-center justify-center my-6">
              <div className="border-t border-zinc-300 w-full absolute"></div>
            ...
            <div className="flex justify-center space-x-4">
              {socialLogins.map((social) => (
                <button
                  key={social.id}
                  type="button"
                  className="p-2 border border-zinc-300 rounded-full hover:bg-zinc-50 transition-colors"
                >
                  {social.icon}
                </button>
              ))}
