...
interface InterviewerState {
  ...
  updateInterviewSetup: (setup: Partial<InterviewerState['interviewSetup']>) => void;
  startNewInterview: (interview: InterviewerState['interviewHistory'][0]) => void;
  addMessage: (interviewId: string, message: InterviewerState['interviewHistory'][0]['messages'][0]) => void;
  updateFeedback: (interviewId: string, feedback: Partial<InterviewerState['interviewHistory'][0]['feedback']>) => void;
...
export const useInterviewerStore = create<InterviewerState>()(
  persist(
    (set) => ({
      ...
      setCurrentStep: (step: InterviewerStep) => 
        set({ currentStep: step }),
      
      updateInterviewSetup: (setup: Partial<InterviewerState['interviewSetup']>) => 
        set((state) => ({
