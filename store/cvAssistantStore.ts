  ...
  persist(
    (set) => ({
      ...
      loadDemoData: () => set({
        ...
        targetJobDescription: "We are looking for an experienced Frontend Developer with React, TypeScript and modern web development practices. The ideal candidate has experience with state management, performance optimization, and building responsive user interfaces.",
